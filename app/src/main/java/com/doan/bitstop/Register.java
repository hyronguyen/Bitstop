...
public class Register extends AppCompatActivity {
    ...
    EditText iuserEdit, imailEdit, ipassEdit, irepassEdit, iaddressEdit, iphoneEdit, icreditEdit, iroleEdit;
    ...
    private void addEvent() {
        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String address = iaddressEdit.getText().toString().trim();
                String phone = iphoneEdit.getText().toString().trim();
                String credit = icreditEdit.getText().toString().trim();
                String role = iroleEdit.getText().toString().trim();
                    ...
                    if (exists) {
                        ...
                        CheckExistedEmail(email, existsEmail -> {
                            if (existsEmail) {
                                ...
                                addUserToFirestore(username, password, email, address, phone, credit, role);
                                finish();
                            }
                        });
                    }
    ...
    private void addControl() {
        ...
        iaddressEdit = findViewById(R.id.input_address);
        iphoneEdit = findViewById(R.id.input_phone);
        icreditEdit = findViewById(R.id.input_credit);
        iroleEdit = findViewById(R.id.input_role);
    }
    ...
    private void addUserToFirestore(String username, String password, String email, String address, String phone, String credit, String role) {
        FirebaseFirestore db = FirebaseFirestore.getInstance();
